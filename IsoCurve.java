 ...
 * through a grid of values.
 *
 * @version $Revision: 1.6 $, $Date: 1996/07/30 04:52:40 $.
...
*********************/
   ...
   */    
     protected void createCells() {
            ...
            if(cells == null)    cells = new Vector();
            else                 cells.removeAllElements();
...
*/
                            ...
                            if( count > 2 ) {
                                ...
                                if( left   ) { cell.face[count] = LEFT;   count++; }
                                if( right  ) { cell.face[count] = RIGHT;  count++; }
                            } 
                   }
